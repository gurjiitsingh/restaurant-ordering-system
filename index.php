                ...
                <div class="hero-section-flex">
                    <div class="hero-section-col">
                        ...
                        <div class="food-box">
                            ...
                            <p class="text-[1rem] lg:text-[1.5rem] ff-Josefin">
...
<section class="gb-container-mob-app" id="contact">
    <div class="gb-container-mob-app-inner">
        ...
        <p class="mdt1" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500" class="gb-headline-online-order-p">
